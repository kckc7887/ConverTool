...
> **当前主线版本：Host v1.2.0**（契约包 `ConverTool.PluginAbstractions` **1.1.0**；内置插件的 manifest `version` 与 Host 一致，见 [`plugin-dev.md`](plugin-dev.md)；历史版本说明见 [`docs/releases/`](releases/)。）
